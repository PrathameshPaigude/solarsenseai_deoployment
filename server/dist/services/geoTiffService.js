...
exports.sampleGeoTIFFForPolygon = sampleGeoTIFFForPolygon;
exports.getGeoTIFFPath = getGeoTIFFPath;
exports.sampleMultipleLayers = sampleMultipleLayers;
 ...
 */
function sampleGeoTIFFForPolygon(geoTiffPath, polygonGeoJson) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (fileDirectory.GeoAsciiParamsTag) {
                ...
                if (params.includes('kWh/m²'))
                    units = 'kWh/m²/day';
                if (params.includes('W/m²'))
                    units = 'W/m²';
            }
        }
        catch (e) {
        ...
        const rastersResult = yield image.readRasters({
        ...
        if (Array.isArray(rastersResult) && rastersResult.length > 0) {
            ...
            if (firstBand && typeof firstBand.length === 'number') {
                rasterArray = Array.from(firstBand);
            }
            else {
 ...
 */
function getGeoTIFFPath(layerName) {
 ...
 */
function sampleMultipleLayers(layerNames, polygonGeoJson) {
    return __awaiter(this, void 0, void 0, function* () {
        const results = {};
        yield Promise.all(layerNames.map((layerName) => __awaiter(this, void 0, void 0, function* () {
            try {
                const layerPath = getGeoTIFFPath(layerName);
                const stats = yield sampleGeoTIFFForPolygon(layerPath, polygonGeoJson);
